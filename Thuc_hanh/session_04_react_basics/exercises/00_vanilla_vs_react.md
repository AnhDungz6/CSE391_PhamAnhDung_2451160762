...
_Minh vừa học xong JavaScript DOM manipulation ở Session 3. Bạn ấy muốn nâng cấp Portfolio (Session 3) sang React. Nhưng trước tiên, cần hiểu: **tại sao phải chuyển?** Bài này sẽ cho bạn trải nghiệm trực tiếp "nỗi đau" khi thao tác DOM — rồi thấy React giải quyết nó như thế nào, qua cùng một ví dụ Todo List đơn giản._
...
> **Mục đích:** Sinh viên phải _trải nghiệm_ sự bất tiện của DOM thuần trước khi được giới thiệu React. Không giảng lý thuyết — để code tự nói lên.
>
...
\*\*← [Quay lại Session 4](../README.md) | → [Tiếp tục Bài 0.5 — JSX: Viết giao diện Portfolio](./0
